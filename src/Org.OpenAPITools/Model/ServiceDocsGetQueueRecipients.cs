...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsGetQueueRecipients")]
    public partial class ServiceDocsGetQueueRecipients : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsGetQueueRecipients" /> class.
        /// </summary>
        ...
        public ServiceDocsGetQueueRecipients(ServiceQueueRecipientOutput data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public ServiceQueueRecipientOutput Data { get; set; }
