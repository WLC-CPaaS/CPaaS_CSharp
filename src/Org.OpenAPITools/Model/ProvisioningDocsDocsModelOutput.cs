...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "provisioning_docs.DocsModelOutput")]
    public partial class ProvisioningDocsDocsModelOutput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvisioningDocsDocsModelOutput" /> class.
        /// </summary>
        ...
        public ProvisioningDocsDocsModelOutput(List<ModelsModel> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ModelsModel> Data { get; set; }
