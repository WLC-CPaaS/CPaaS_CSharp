...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.E911LocationOutput")]
    public partial class ServiceE911LocationOutput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceE911LocationOutput" /> class.
        /// </summary>
        ...
        public ServiceE911LocationOutput(string activatedTime = default, string address1 = default, string address2 = default, string callerName = default, string comments = default, string community = default, string customerOrderId = default, decimal latitude = default, ServiceE911LegacyDataOutput legacyData = default, string locationId = default, decimal longitude = default, string plusFour = default, string postalCode = default, string state = default, ServiceE911StatusOutput status = default, string type = default, string updateTime = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "customer_order_id", EmitDefaultValue = false)]
        ...
        public ServiceE911LegacyDataOutput LegacyData { get; set; }
        ...
        public ServiceE911StatusOutput Status { get; set; }
