...
namespace Org.OpenAPITools.Model
{
    ...
    /// ServiceTTS
    /// </summary>
    [DataContract(Name = "service.TTS")]
    public partial class ServiceTTS : IValidatableObject
    {
        /// <summary>
        /// Defines Voice
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceTTS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ServiceTTS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceTTS" /> class.
        /// </summary>
        /// <param name="text">text (required).</param>
        /// <param name="voice">voice.</param>
        public ServiceTTS(string text = default, VoiceEnum? voice = default)
        {
            // to ensure "text" is required (not null)
            if (text == null)
            {
                throw new ArgumentNullException("text is a required property for ServiceTTS and cannot be null");
            }
            this.Text = text;
            this.Voice = voice;
        }
