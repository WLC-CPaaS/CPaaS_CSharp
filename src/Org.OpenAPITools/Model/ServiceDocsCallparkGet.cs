...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsCallparkGet")]
    public partial class ServiceDocsCallparkGet : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsCallparkGet" /> class.
        /// </summary>
        ...
        public ServiceDocsCallparkGet(List<Dictionary<string, ServiceParkingSlotData>> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<Dictionary<string, ServiceParkingSlotData>> Data { get; set; }
