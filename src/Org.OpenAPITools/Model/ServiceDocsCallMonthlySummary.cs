...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsCallMonthlySummary")]
    public partial class ServiceDocsCallMonthlySummary : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsCallMonthlySummary" /> class.
        /// </summary>
        ...
        public ServiceDocsCallMonthlySummary(List<ModelCallMonthlySummary> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ModelCallMonthlySummary> Data { get; set; }
