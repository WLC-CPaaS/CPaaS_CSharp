...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsCallRecordingGetAll")]
    public partial class ServiceDocsCallRecordingGetAll : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsCallRecordingGetAll" /> class.
        /// </summary>
        ...
        public ServiceDocsCallRecordingGetAll(List<ServiceCallRecordingOutput> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ServiceCallRecordingOutput> Data { get; set; }
