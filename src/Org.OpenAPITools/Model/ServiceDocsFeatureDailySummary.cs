...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsFeatureDailySummary")]
    public partial class ServiceDocsFeatureDailySummary : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsFeatureDailySummary" /> class.
        /// </summary>
        ...
        public ServiceDocsFeatureDailySummary(List<ModelFeatureDailySummary> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ModelFeatureDailySummary> Data { get; set; }
