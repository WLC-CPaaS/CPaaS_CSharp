...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsDeviceGetAll")]
    public partial class ServiceDocsDeviceGetAll : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsDeviceGetAll" /> class.
        /// </summary>
        ...
        public ServiceDocsDeviceGetAll(List<ServiceDeviceOutputShort> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ServiceDeviceOutputShort> Data { get; set; }
