...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsEventMonthlySummary")]
    public partial class ServiceDocsEventMonthlySummary : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsEventMonthlySummary" /> class.
        /// </summary>
        ...
        public ServiceDocsEventMonthlySummary(List<ModelEventMonthlySummary> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ModelEventMonthlySummary> Data { get; set; }
