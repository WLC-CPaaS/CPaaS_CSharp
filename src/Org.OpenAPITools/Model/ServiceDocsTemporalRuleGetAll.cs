...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsTemporalRuleGetAll")]
    public partial class ServiceDocsTemporalRuleGetAll : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsTemporalRuleGetAll" /> class.
        /// </summary>
        ...
        public ServiceDocsTemporalRuleGetAll(List<ServiceTemporalRuleOutputShort> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ServiceTemporalRuleOutputShort> Data { get; set; }
