...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "provisioning_docs.DocsFamilyOutput")]
    public partial class ProvisioningDocsDocsFamilyOutput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvisioningDocsDocsFamilyOutput" /> class.
        /// </summary>
        ...
        public ProvisioningDocsDocsFamilyOutput(List<ModelsFamily> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ModelsFamily> Data { get; set; }
