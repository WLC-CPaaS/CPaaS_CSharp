...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsEventDetail")]
    public partial class ServiceDocsEventDetail : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsEventDetail" /> class.
        /// </summary>
        ...
        public ServiceDocsEventDetail(List<ModelEventDetail> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ModelEventDetail> Data { get; set; }
