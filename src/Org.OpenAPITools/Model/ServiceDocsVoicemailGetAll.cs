...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsVoicemailGetAll")]
    public partial class ServiceDocsVoicemailGetAll : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsVoicemailGetAll" /> class.
        /// </summary>
        ...
        public ServiceDocsVoicemailGetAll(List<ServiceVoicemailOutputShort> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ServiceVoicemailOutputShort> Data { get; set; }
