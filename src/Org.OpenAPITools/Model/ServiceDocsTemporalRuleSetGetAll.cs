...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsTemporalRuleSetGetAll")]
    public partial class ServiceDocsTemporalRuleSetGetAll : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsTemporalRuleSetGetAll" /> class.
        /// </summary>
        ...
        public ServiceDocsTemporalRuleSetGetAll(List<ServiceTemporalRuleSetOutputShort> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ServiceTemporalRuleSetOutputShort> Data { get; set; }
