...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "provisioning_docs.DocsConfigFileOutput")]
    public partial class ProvisioningDocsDocsConfigFileOutput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvisioningDocsDocsConfigFileOutput" /> class.
        /// </summary>
        ...
        public ProvisioningDocsDocsConfigFileOutput(string data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
