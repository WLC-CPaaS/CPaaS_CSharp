...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsMediaGetAll")]
    public partial class ServiceDocsMediaGetAll : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsMediaGetAll" /> class.
        /// </summary>
        ...
        public ServiceDocsMediaGetAll(List<ServiceMediaOutputShort> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ServiceMediaOutputShort> Data { get; set; }
