...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsCdrGetAll")]
    public partial class ServiceDocsCdrGetAll : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsCdrGetAll" /> class.
        /// </summary>
        ...
        public ServiceDocsCdrGetAll(List<ServiceCdrOutputShort> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ServiceCdrOutputShort> Data { get; set; }
