...
namespace Org.OpenAPITools.Model
{
    ...
    /// MenuOutputList
    /// </summary>
    [DataContract(Name = "MenuOutputList")]
    public partial class MenuOutputList : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MenuOutputList" /> class.
        /// </summary>
        ...
        public MenuOutputList(List<MenuOutputListData> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<MenuOutputListData> Data { get; set; }
