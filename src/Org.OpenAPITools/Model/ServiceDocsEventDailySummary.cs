...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsEventDailySummary")]
    public partial class ServiceDocsEventDailySummary : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsEventDailySummary" /> class.
        /// </summary>
        ...
        public ServiceDocsEventDailySummary(List<ModelEventDailySummary> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ModelEventDailySummary> Data { get; set; }
