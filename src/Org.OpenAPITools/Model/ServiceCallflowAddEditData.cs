...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.CallflowAddEditData")]
    public partial class ServiceCallflowAddEditData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCallflowAddEditData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ServiceCallflowAddEditData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCallflowAddEditData" /> class.
        /// </summary>
        ...
        public ServiceCallflowAddEditData(ServiceFeatureCode featurecode = default, ServiceCallflowAddEditFlowData flow = default, string name = default, List<string> numbers = default, List<string> patterns = default)
        {
            // to ensure "flow" is required (not null)
            if (flow == null)
            {
                throw new ArgumentNullException("flow is a required property for ServiceCallflowAddEditData and cannot be null");
            }
            this.Flow = flow;
            // to ensure "numbers" is required (not null)
            if (numbers == null)
            {
                throw new ArgumentNullException("numbers is a required property for ServiceCallflowAddEditData and cannot be null");
            }
            this.Numbers = numbers;
            // to ensure "patterns" is required (not null)
            if (patterns == null)
            {
                throw new ArgumentNullException("patterns is a required property for ServiceCallflowAddEditData and cannot be null");
            }
