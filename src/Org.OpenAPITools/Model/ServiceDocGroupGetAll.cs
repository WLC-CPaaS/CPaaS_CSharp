...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocGroupGetAll")]
    public partial class ServiceDocGroupGetAll : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocGroupGetAll" /> class.
        /// </summary>
        ...
        public ServiceDocGroupGetAll(List<ServiceGroupOutputShort> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ServiceGroupOutputShort> Data { get; set; }
