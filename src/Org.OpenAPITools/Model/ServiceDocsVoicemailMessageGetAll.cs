...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsVoicemailMessageGetAll")]
    public partial class ServiceDocsVoicemailMessageGetAll : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsVoicemailMessageGetAll" /> class.
        /// </summary>
        ...
        public ServiceDocsVoicemailMessageGetAll(List<ServiceVoicemailMessageOutput> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ServiceVoicemailMessageOutput> Data { get; set; }
