...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsCallQueueGetAll")]
    public partial class ServiceDocsCallQueueGetAll : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsCallQueueGetAll" /> class.
        /// </summary>
        ...
        public ServiceDocsCallQueueGetAll(List<ServiceCallQueueOutputShort> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ServiceCallQueueOutputShort> Data { get; set; }
