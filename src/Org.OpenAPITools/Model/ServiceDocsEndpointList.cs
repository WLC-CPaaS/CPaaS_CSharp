...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsEndpointList")]
    public partial class ServiceDocsEndpointList : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsEndpointList" /> class.
        /// </summary>
        ...
        public ServiceDocsEndpointList(List<ModelEndpointList> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ModelEndpointList> Data { get; set; }
