...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsAccountGetAll")]
    public partial class ServiceDocsAccountGetAll : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsAccountGetAll" /> class.
        /// </summary>
        ...
        public ServiceDocsAccountGetAll(List<ServiceAccountOutputShort> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ServiceAccountOutputShort> Data { get; set; }
