...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.VOIPDeviceAddEditProvision")]
    public partial class ServiceVOIPDeviceAddEditProvision : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceVOIPDeviceAddEditProvision" /> class.
        /// </summary>
        ...
        public ServiceVOIPDeviceAddEditProvision(string endpointBrand = default, string endpointFamily = default, string endpointModel = default, string id = default, List<ServiceVOIPDeviceAddEditLineKey> lineKeys = default)
        {
        ...
        public List<ServiceVOIPDeviceAddEditLineKey> LineKeys { get; set; }
