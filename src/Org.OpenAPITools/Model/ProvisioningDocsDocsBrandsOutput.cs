...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "provisioning_docs.DocsBrandsOutput")]
    public partial class ProvisioningDocsDocsBrandsOutput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvisioningDocsDocsBrandsOutput" /> class.
        /// </summary>
        ...
        public ProvisioningDocsDocsBrandsOutput(List<ModelsBrand> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ModelsBrand> Data { get; set; }
