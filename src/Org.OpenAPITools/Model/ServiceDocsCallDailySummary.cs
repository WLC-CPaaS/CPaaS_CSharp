...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsCallDailySummary")]
    public partial class ServiceDocsCallDailySummary : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsCallDailySummary" /> class.
        /// </summary>
        ...
        public ServiceDocsCallDailySummary(List<ModelCallDailySummary> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ModelCallDailySummary> Data { get; set; }
