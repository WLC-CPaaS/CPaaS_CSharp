...
namespace Org.OpenAPITools.Model
{
    ...
    /// ServiceWebhookEdit
    /// </summary>
    [DataContract(Name = "service.WebhookEdit")]
    public partial class ServiceWebhookEdit : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceWebhookEdit" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ServiceWebhookEdit() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceWebhookEdit" /> class.
        /// </summary>
        ...
        public ServiceWebhookEdit(CallbackMethodEnum callbackMethod = default, string callbackUrl = default, Dictionary<string, Object> data = default, bool isActive = default, string title = default, string webhookType = default)
        {
            this.CallbackMethod = callbackMethod;
            // to ensure "callbackUrl" is required (not null)
            if (callbackUrl == null)
            {
                throw new ArgumentNullException("callbackUrl is a required property for ServiceWebhookEdit and cannot be null");
            }
            this.CallbackUrl = callbackUrl;
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for ServiceWebhookEdit and cannot be null");
            }
            this.Title = title;
            // to ensure "webhookType" is required (not null)
            if (webhookType == null)
            {
                throw new ArgumentNullException("webhookType is a required property for ServiceWebhookEdit and cannot be null");
            }
