...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsFeatureMonthlySummary")]
    public partial class ServiceDocsFeatureMonthlySummary : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsFeatureMonthlySummary" /> class.
        /// </summary>
        ...
        public ServiceDocsFeatureMonthlySummary(List<ModelFeatureMonthlySummary> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ModelFeatureMonthlySummary> Data { get; set; }
