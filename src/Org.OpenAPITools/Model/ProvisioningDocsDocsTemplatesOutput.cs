...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "provisioning_docs.DocsTemplatesOutput")]
    public partial class ProvisioningDocsDocsTemplatesOutput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvisioningDocsDocsTemplatesOutput" /> class.
        /// </summary>
        ...
        public ProvisioningDocsDocsTemplatesOutput(List<ModelsTemplate> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ModelsTemplate> Data { get; set; }
