...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsAccountPhonenumberGetAll")]
    public partial class ServiceDocsAccountPhonenumberGetAll : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsAccountPhonenumberGetAll" /> class.
        /// </summary>
        ...
        public ServiceDocsAccountPhonenumberGetAll(List<ServicePhonenumberOutput> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ServicePhonenumberOutput> Data { get; set; }
