...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsCallDetail")]
    public partial class ServiceDocsCallDetail : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsCallDetail" /> class.
        /// </summary>
        ...
        public ServiceDocsCallDetail(List<ModelCallDetail> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ModelCallDetail> Data { get; set; }
