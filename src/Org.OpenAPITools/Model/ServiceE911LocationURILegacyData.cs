...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service_E911LocationURI_legacyData")]
    public partial class ServiceE911LocationURILegacyData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceE911LocationURILegacyData" /> class.
        /// </summary>
        /// <param name="houseNumber">houseNumber.</param>
        /// <param name="predirectional">predirectional.</param>
        /// <param name="streetName">streetName.</param>
        /// <param name="suite">suite.</param>
        public ServiceE911LocationURILegacyData(string houseNumber = default, string predirectional = default, string streetName = default, string suite = default)
        {
