...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsUserGetAll")]
    public partial class ServiceDocsUserGetAll : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsUserGetAll" /> class.
        /// </summary>
        ...
        public ServiceDocsUserGetAll(List<ServiceUserOutputShort> data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public List<ServiceUserOutputShort> Data { get; set; }
