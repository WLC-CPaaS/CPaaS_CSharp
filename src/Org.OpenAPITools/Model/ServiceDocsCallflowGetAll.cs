...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "service.DocsCallflowGetAll")]
    public partial class ServiceDocsCallflowGetAll : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDocsCallflowGetAll" /> class.
        /// </summary>
        ...
        public ServiceDocsCallflowGetAll(ServiceCallflowOutputShort data = default, string nextStartKey = default, int pageSize = default, string requestId = default, string startKey = default, int statusCode = default)
        {
            this.Data = data;
        ...
        public ServiceCallflowOutputShort Data { get; set; }
